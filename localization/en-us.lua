return {
	descriptions = {
		...
		Tag = {
			...
			tag_crp_uncommon_2_tag = {
				...
				text = {
					"Shop has a free",
					"{C:uncommon}Average{} {C:attention}Joker",
				},
			},
			tag_crp_rare_2_tag = {
				name = "Well Done Tag",
				text = {
					"Shop has a free",
					"{C:rare}Well Done{} {C:attention}Joker",
				},
			},
			tag_crp_m_tag = {
				name = "M Tag",
	...
	misc = {
		dictionary = {
			...
			k_crp_trash = "Trash",
			["k_crp_:3"] = ":3",
			k_crp_common_2 = "Plentiful",
			k_crp_2common4me = "2Common4me",
			k_crp_uncommon_2 = "Average",
			k_crp_unrare = "Unrare",
			k_crp_rare_2 = "Well Done",
